...
toNearest = 1%internal.stats.parseOnOff(toNearest,'UseNearest');
...
useParallel = false% internal.stats.parallel.processParallelAndStreamOptions(paropts,true);
